...
# ==============================================================================
# ALTERAÇÃO CRÍTICA: INICIALIZAÇÃO ESTÁVEL DO CLIENTE
# ==============================================================================
@st.cache_resource
def get_gemini_client():
    # Esta linha garante que o cliente seja criado apenas uma vez e reutilizado
    # usando a chave salva no seu Secrets.
    return genai.Client(api_key=st.secrets["GEMINI_API_KEY"])

client = get_gemini_client()

# ==============================================================================
# O RESTANTE DO SEU CÓDIGO (PROMPT MESTRE E LÓGICA)
# ==============================================================================
PROMPT_MESTRE = """
...
if st.sidebar.button("🔄 Executar Protocolo Mestre"):
    with st.spinner("🤖 Consultando Google Gemini..."):
        try:
            # Usando o objeto client inicializado no topo
