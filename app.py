...
def engine_coleta_dados():
    # Siglas de estabilidade total para evitar "Erro" na Grade
    ativos = {
    ...
    for nome, ticker in ativos.items():
        try:
            ...
            if not df.empty and len(df) >= 2:
                ...
                if ticker in ["BOVA11.SA", "ES=F"] and not bloco_noticias:
                ...
                grade_texto += f"- {nome}: Dados de oscilação indisponíveis.\n"
